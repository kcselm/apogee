...
SOLVE=1 pnpm --filter @apogee/engine exec vitest run level-stats 2>&1 | grep -P '^(id\t|[0-9]+-[0-9]+\t)' > .superpowers/sdd/2026-09-09-apogee-difficulty-structure/before.tsv
...
SOLVE=1 pnpm --filter @apogee/engine exec vitest run level-stats 2>&1 | grep -P '^(id\t|[0-9]+-[0-9]+\t)' > $W/after.tsv
